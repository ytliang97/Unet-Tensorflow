...
if __name__ == '__main__':
    ...
    data_root = "/DataCenter/company/DataCenter/Carvana"
    ...
    if not os.path.exists(os.path.join("./Carvana", "tfrecords")):
        os.makedirs(os.path.join("./Carvana", "tfrecords"))
    writer = tf.python_io.TFRecordWriter(os.path.join("./Carvana", "tfrecords", 
        "Carvana.tfrecords"))

    for image_name in image_names:
        # image_name
        image_raw_file = os.path.join(data_root, "train", image_name)
        image_label_file = os.path.join(data_root, "train_masks_jpg", 
